    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Purchase Outstanding Report</li>
            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Purchase Outstanding Report</h4>
...
<!--                    </div>-->
                    <div class="form-group col-md-3 col-lg-2">
                        ...
                        <button
                            ...
                            @click="getPurchaseOutstanding(1)"
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Purchase Outstanding Report List</h6>
            </div>
            <div class="card-body">
                <!-- sort by -->
...
<!--                </div>-->
                ...
                <div class="table-responsive" v-if="out_count>0">
                 ...
                 <div v-else>
                    <h5 class="text-center m-5">No Purchase Outstanding found!</h5>
                </div>
            </div>
        </div>
        <!-- table end -->
