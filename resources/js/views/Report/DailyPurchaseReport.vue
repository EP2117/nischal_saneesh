    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Daily Purchase Report</li>
            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Daily Purchase  Report</h4>
...
<!--                    </div>-->
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Daily Purchase Report</h6>
            </div>
            <div class="card-body">
                <!-- sort by -->
                <!-- <div class="form-group float-left pr-2" v-if="purchases.length > 0">
                ...
                <!-- <div v-if="purchases.length > 0"> -->
                    ...
                    <!-- <div class="form-group float-left">
                        <select id="purchase" class="form-control mt-2"
                                name="purchase" v-model="search.purchase" style="width:150px; margin-left:10px;" @change="getDailyPurchases(1)"
                        >
                            <option value="">Select One</option>
                    ...
                    <div class="text-right form-group " >
                        <div class="text-right mb-2" v-if="purchases.length > 0">
                ...
                <div class="table-responsive" v-if="purchases.length > 0">
                    <table class="table table-bpurchaseed table-striped table_no" id="dataTable" width="100%" cellspacing="0">  <!--kamlesh-->
                        <thead>
                        <tr>
                        ...
                        <tbody id="result">
                            ...
                            <tr>
                                <th colspan="5" class="text-right"><strong><h4>Total</h4></strong></th>
...
export default {
    ...
    methods: {
        ...
        getDailyPurchases(page = 1) {
            ...
            axios.get("/report/daily_purchase?" + search)
                .then(res=> {
                    console.log(res);
                   app.purchases=res.data.purchase;
                   app.sub_total=res.data.sub_total;
                    $('#loading').hide();
                })
                .catch(error => {
                    console.log(error);
        ...
        exportExcel() {
            ...
            window.open(this.site_path+'/report/daily_purchase_export?'+search);
        },
