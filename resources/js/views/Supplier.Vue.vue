            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-4 col-lg-3">
                        ...
                        <input type="text" class="form-control" id="cus_code" name="cus_code" v-model="search.supplier_code">
                    </div>
                    <div class="form-group col-md-4 col-lg-3">
                        <label for="cus_name">Supplier Name</label>
                        <input type="text" class="form-control" id="cus_name" name="cus_name" v-model="search.supplier_name">
                    </div>
...
<!--         table start -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive" v-if="supplier_count > 0">
                    <!-- sort by -->
                    <div class="form-group float-left pr-2">
                        <label for="sort_by">Sort By</label>
                        <select id="sort_by" class="form-control"
                                name="sort_by" v-model="search.sort_by" style="width:200px" @change="getSuppliers(1)">
                            <option value="">Select One</option>
                            <option value="supplier_code">Code</option>
                            <option value="name">Name</option>
                            <option value="phone_number">Phone</option>
                            <option value="supplier_shipping_address">Address</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <div class="form-group float-left">
                            <select id="order" class="form-control mt-2"
                                    name="order" v-model="search.order" style="width:150px; margin-left:10px;" @change="getSuppliers(1)">
                                <option value="">Select One</option>
                                <option value="ASC">Ascending</option>
                                <option value="DESC">Descending</option>
                            </select>
...
<!--                            <td></td>-->
                            ...
                            <td class="mm-txt">{{sup.name}}</td>
                            <td>{{sup.phone_number}}</td>
                            <td class="mm-txt">{{sup.township.township_name + ', ' + sup.state.state_name + ', ' + sup.country.country_name }}</td>
                            <td v-if="sup.is_active == 1">
            ...
            <div class="card-footer text-center">
                ...
                <div class="row" style="overflow:auto">
                    <div class="col-12">
                        <template v-if="supplier_count > 0">
                            <div class="overflow-auto text-center" style="display:inline-block">
                                ...
                                <b-pagination
                                    ...
                                    <template v-slot:page="{ page, active }">
                                        ...
                                        <span v-else v-on:click="getSuppliers(page)">{{ page }}</span>
                                    </template>
                                </b-pagination>
                            </div>
                        </template>
...
export default {
    ...
    methods: {
                ...
                if (willDelete) {
                    ...
                    axios
                        ...
                        .then(function(response) {
                            $("#loading").hide();
                            app.getSuppliers(app.currentPage);
        ...
        getSuppliers(page = 1) {
            ...
            var search =
                "&supplier_code=" +
                app.search.supplier_code +
                "&supplier_name=" +
                app.search.supplier_name +
                "&state_id=" +
                app.search.state_id +
                "&township_id=" +
                ...
                "&sort_by=" +
                app.search.sort_by;
            axios.get("/supplier/get_suppliers?page=" + page + search).then(function(response) {
                // console.log(response.data);
                $("#loading").hide();
                let data = response.data.data;
                app.suppliers = data.data;
                app.supplier_count = app.suppliers.length;
