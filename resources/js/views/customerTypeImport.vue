	...
	<div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Customer Type Import</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Customer Type Import</h4>
        </div>
	...
	export default {
		...
		methods: {
		    ...
		    onSubmit() {
		      ...
		      axios.post('import/customer_type', data)
		        .then(response => {        
		        $("#loading").hide();
