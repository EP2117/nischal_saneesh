	...
	<div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Product Min/Percentage QTY Import</li>

            </ol>
        </nav>
        <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800">Product Min/Percentage QTY Import</h4>
        </div>
	...
	export default {
		...
		methods: {
		    ...
		    onSubmit() {
		      ...
		      axios.post('import/product_min_percentage_qty', data)
		        .then(response => {        
		        $("#loading").hide();
