<template>
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0 text-gray-800" v-if="!isEdit">Create New Payment</h4>
            <h4 class="mb-0 text-gray-800" v-else>Edit Payment</h4>
                ...
                <div class="d-block">
                    ...
                    <form class="form" method="post" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)">
                        ...
                        <div class="form-group  row">
                            <label class="col-lg-3 text-right col-form-label form-control-label">Cash Payment No:</label>
                            <div class="col-lg-6 col-md-offset-2">
                                <input class="form-control" type="text"
                                       v-model="form.cash_payment_no" readonly required >
                            </div>
                        </div>
                        <div class="form-group  row">
...
export default {
    ...
    methods:{
        ...
        onSubmit:function (event){
            ...
            $("#loading").show();
            if (!this.isEdit) {
                this.form.post('/payment/store').then(function (data){
                ...
                this.form.patch('/payment/update/'+app.payment_id).then(function (data){
                    if(data.status=='success'){
                        event.target.reset();
                        $("#debit_id").select2();
                        $("#credit_id").select2();
