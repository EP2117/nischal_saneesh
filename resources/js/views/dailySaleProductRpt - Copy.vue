                    ...
                    <table class="table table-bordered table-striped table_no" id="dataTable" width="100%" cellspacing="0">  <!--kamlesh-->
                        ...
                        <tbody>
                            <template v-for="sale in sales">
                                <template v-if="search.product_name != '' || search.brand_id != ''">
                                    <template v-if="user_role != 'Country Head'">
                                        <template v-for="product in sale.products" >
                                        <tr v-if="(search.product_name != '' && search.brand_id != '' && product.product_name.toLowerCase().includes(search.product_name.toLowerCase()) && search.brand_id == product.brand_id) || (search.product_name == '' && search.brand_id != '' && search.brand_id == product.brand_id) || (search.product_name != '' && search.brand_id == '' && product.product_name.toLowerCase().includes(search.product_name.toLowerCase()))">
                                            ...
                                            <td v-else></td>
                                            <td class="textalign">{{product.product_code}}</td>
                                            <td class="mm-txt textalign">{{product.product_name}}</td>
                                            <td class="textalign">{{product.pivot.product_quantity}}</td>
                                            <td class="textalign">{{getSellingUom(product,product.pivot.uom_id)}}</td>
                                            <td class="text-right" v-if="product.pivot.is_foc== '0'">{{product.pivot.price}}</td>
                                            <td v-else>FOC</td>
                                    ...
                                    <template v-else>
                                        <template v-for="product in sale.products">
                                        <tr v-if="((search.product_name != '' && search.brand_id != '' && product.product_name.toLowerCase().includes(search.product_name.toLowerCase()) && search.brand_id == product.brand_id) || (search.product_name == '' && search.brand_id != '' && search.brand_id == product.brand_id) || (search.product_name != '' && search.brand_id == '' && product.product_name.toLowerCase().includes(search.product_name.toLowerCase()))) && brands.findIndex(x => x.id == product.brand_id) > -1">
                                            <td class="text-right"></td>
                                            <td class="textalign">{{sale.invoice_no}}</td>
                                            <td class="textalign">{{sale.invoice_date}}</td>
                                            <td v-if="sale.branch != null">{{sale.branch.branch_name}}</td>
