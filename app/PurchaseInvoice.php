...
//    protected $fillable=['invoice_no','reference_no','invoice_date','supplier_id']
    ...
    {
        return $this->belongsToMany('App\Product', 'product_sale', 'purchase_id', 'product_id')->withPivot('id','uom_id','product_quantity','delivered_quantity','price','price_variant','total_amount','is_foc');
    }
